...
class Token_Test extends FlatSpec{
  ...
  "parse" should "run" in{
    ...
    val (temp1, strV1, intV1) = fb.parseDeclare(tokens, Set(), Set())
    println(strV1)
    println(intV1)
    println(temp1)
    println("==========")
    val (temp2, strV2, intV2) = fb.parseDeclare(temp1, strV1, intV1)
    println(strV2)
    println(intV2)
    println(temp2)
    println("==========")
    val (temp3, strV3, intV3) = fb.parseDeclare(temp2, strV2, intV2)
    println(strV3)
    println(intV3)
    println(temp3)
    println("==========")
    val (temp4, strV4, intV4) = fb.parseDeclare(temp3, strV3, intV3)
    println(strV4)
    println(intV4)
    println(temp4)
    println("==========")
