...
object Z3Exp {
  ...
  def toZ3Input(len_in: Int, len_out: Int, sls: Set[((Int, Int), Set[(Int, Int)])]): String = {
    val idxMap = (sls.toList.indices zip sls).map(x => x._1 -> (x._2._1, (x._2._2.toList.indices zip x._2._2).toMap))
    val formula = idxMap.map(
      x => Op2Exp("and", getLinear(x._1, x._2._1._1, len_in, x._2._2.map(y => y._1 -> y._2._1)),
        getLinear(x._1, x._2._1._2, len_out, x._2._2.map(y => y._1 -> y._2._2)))
